                        ...
                        case XmlNodeType.Comment:
                            {
                                ...
                                {
                                    // Path.GetFullPath doesn't like wildcards, so handle that problem.
                                    string safePath = commentParts[1].Replace("*", "_$$_");
                                    string path = Path.GetFullPath(wxsDirectory + Path.DirectorySeparatorChar + safePath);
